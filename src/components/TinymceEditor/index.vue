<template>
  <div class="tinymce-box">
    <slot/>
    <Editor v-model="contentValue" :init="initOptions" :id="props.id" :disabled="disabled"  @change="callBack"/>
  </div>
</template>
...
import 'tinymce/models/dom'; // dom模块
...
const emits = defineEmits(['update:value','callBack'])
...
const initOptions = reactive({
  ...
  placeholder: props.placeholder, // 提示文字
